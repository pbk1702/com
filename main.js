...
const sensBase = 25.0 // изначально было 4000.0 // базовый множитель чувствительности
...
function drawFrame(timeStamp) {
  ...
  y = 0
  w = canvas.width
  h = canvas.height * 0.618
  drawGauge0( { ctx, x, y, w, h } )
  
  w = canvas.width
  h = canvas.height * 0.382
  x = 0
  y = canvas.height - h
